...
MockHttpClient createMockImageHttpClient(SecurityContext? _) {
  ...
  final transparentImage = getTestImageData();
...
class MockHttpClient extends Mock implements HttpClient {
  ...
  @override
  Future<HttpClientRequest> open(String? method, String? host, int? port, String? path) => super.noSuchMethod(
...
class MockHttpClientResponse extends Mock implements HttpClientResponse {
  ...
  @override
  Future<HttpClientResponse> redirect([String? method, Uri? url, bool? followLoops]) => super.noSuchMethod(
